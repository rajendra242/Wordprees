...
if(class_exists('Walker_Nav_Menu')):
    ...
    class mediciti_lite_Nav_Walker extends Walker_Nav_Menu {
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'manage_options' ) ) {
                ...
                if ( $menu_class )
                    $fb_output .= ' class="nav navbar-nav navbar-right ' . esc_attr($menu_class) . '"';

                $fb_output .= '>';
                $fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '"><i class="fa fa-plus-circle" aria-hidden="true"></i>'.esc_html__('Add a menu','mediciti-lite').'</a></li>';
                $fb_output .= '</ul>';
