...
$wp_customize->selective_refresh->add_partial( 'section_contactform_title', array(
        'selector' => '#cnt-page p.contact-heading',
) );
$wp_customize->selective_refresh->add_partial( 'cf_desc_', array(
        'selector' => '#section5 h3.section-subheading',
) );
$wp_customize->selective_refresh->add_partial( 'col_sub', array(
        'selector' => '#section1 h3.section-subheading',
) );        
}
