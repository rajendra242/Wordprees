jQuery(document).ready(function($) {
    ...
    //other admin js here.
    var notice = '<div class="notice-upgrade" style="text-align:center">';
    notice += '<a class="upgrade-pro-demo" target="_blank" href="https://webdevrajan.com/demo/doctorial-pro"><img src="https://webdevrajan.com/resources/doctorial-buy.jpg"/></a></div>';
    jQuery('#customize-info').append(notice);
